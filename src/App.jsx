    ...
    <>
      ...
      bg-contain bg-no-repeat ">
        <header className="container mx-auto px-4 pt-8">
          ...
          <form className="flex items-center gap-4 overflow-hidden rounded-md bg-white mt-8 py-4">
        ...
        <main className="container mx-auto mt-8 px-4">
          <div className="rounded-md bg-white [&>article]:p-4">
            ...
            <article className="flex gap-4 border-b border-b-gray-400">
              <button className="inline-block h-5 w-5 flex-none
              rounded-full border-2"></button>
            ...
            <section className="flex justify-between py-4 px-4 ">
              <span className="text-gray-400">5 itemps left</span>
        ...
        <p className="text-center mt-8">Drag Completed</p>
      </div>
    </>
  )
}
